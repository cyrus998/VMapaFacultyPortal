                        ...
                        <div class="max-w-lg flex flex-col bg-white relative overflow-hidden rounded-lg border border-gray-100 p-8">
                            ...
                            <div class="justify-between sm:flex">
                                <div>
                                    ...
                                    <a class="text-sm text-sky-700" wire:click="showEditPostModal({{ $selfinfo->id }})">Click
                                        to
                                        edit.</a>

                                    <p class="mt-1 text-xs font-medium text-gray-600">Faculty Number:
                                        {{ $selfinfo->facultyNumber }}
                                    </p>
                                </div>

                                <div class="ml-3 hidden flex-shrink-0 sm:block">
                                    <img alt="insert image" src="{{ Storage::url($selfinfo->image) }}" class="h-16 w-16 rounded-full object-cover shadow-sm" />
                                </div>
                            </div>
                            ...
                            <dl class="mt-6 flex">
                                <div class="flex flex-col-reverse">
                                    ...
                                    <div class="sm:ml-3 mt-1.5 sm:mt-0">
                                        <dt class="text-gray-500">Batch: {{ $selfinfo->yeargraduated }} <br>
                                            {{ $selfinfo->collegename }}
                                        </dt>
                                        <dd class="font-medium"></dd>
                                    </div>
                                </div>
