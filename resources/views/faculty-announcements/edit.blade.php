...
<body>
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-primary" href="{{ route('faculty-announcements.index') }}" enctype="multipart/form-data"> Back</a>
            </div>
        </div>
    </div>
  ...
  @endif
    ...
    <form action="{{ route('faculty-announcements.update',$announcement->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
