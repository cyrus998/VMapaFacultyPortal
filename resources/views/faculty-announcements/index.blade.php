    ...
    <section class="m-5">
        ...
        <div class="relative mx-auto max-w-7xl">
            <div class="grid max-w-lg gap-12 mx-auto mt-12 lg:grid-cols-3 lg:max-w-none">
                ...
                @foreach ($faculty-announcements as $announcement)
                    <div class="flex flex-col mb-12 overflow-hidden cursor-pointer shadow-lg">
                        ...
                        @if (Auth::check())
                            @if (Auth::user()->role == '1')
                                <form action="{{ route('faculty-announcements.destroy', $announcement->hashid) }}" method="Post" class="mb-5 mt-3 m-3">
                                    <a class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
                                        href="{{ route('faculty-announcements.edit', $announcement->hashid) }}">Edit</a>
                                    @csrf
                                    @method('DELETE')
