    ...
    <div class="lg:flex">
        <div class="lg:w-1/2 xl:max-w-screen-sm">
            <div class="py-12 bg-gray-800 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                <div class="cursor-pointer flex items-center">
                    <div>
                        <img class="w-24" src="https://cdn.discordapp.com/attachments/971130306751000636/1013875835075317790/Mapahs-modified.png" alt="">
                    </div>
                    <div class="text-4xl bg-radial-at-bl from-sky-400 via-teal-900 to-blue-900 bg-gradient-to-r bg-clip-text text-transparent tracking-wide ml-2 font-semibold">Victorino Mapa High School Official.</div>
                </div>
            </div>
            ...
            <div class="mt-5 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                <h2 class="text-center text-4xl text-indigo-900 font-display font-semibold lg:text-left xl:text-5xl
                    xl:text-bold">Faculty Log in</h2>
                <div class="mt-12">
                    <form method="POST" action="{{ route('login') }}">
                        @csrf
                        <div>
                            <div class="text-sm font-bold text-gray-700 tracking-wide">Email Address</div>
                            <x-jet-input id="email" type="email" name="email" :value="old('email')" required class=" p-2 w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Enter your registered email here" />
                        </div>
                        <div class="mt-8">
        ...
        <div class="hidden lg:flex items-center justify-center bg-gray-800 flex-1 h-screen">
            <div class="max-w-xs transform duration-200 hover:scale-110 cursor-pointer">
                <img src="https://cdn-icons-png.flaticon.com/512/5431/5431682.png" alt="">
            </div>
        </div>
    </div>
</body>
