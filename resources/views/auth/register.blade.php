    ...
    <div class="lg:flex">
        <div class="lg:w-1/2 xl:max-w-screen-sm">
            <div class="p-9 bg-gray-900 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                <div class="cursor-pointer flex items-center">
                    <div>
                        <img class="w-16" src="https://cdn.discordapp.com/attachments/971130306751000636/1013875835075317790/Mapahs-modified.png" alt="">
                    </div>
                    <div class="text-4xl text-indigo-800 tracking-wide ml-2 font-semibold">Victorino Mapa High School Official.</div>
                </div>
            </div>
            ...
            <div class="mt-5 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-1 xl:px-24 xl:max-w-2xl">
                <h2 class="text-center text-2xl text-indigo-900 font-display font-semibold lg:text-left xl:text-3xl
                    xl:text-bold">Faculty Register</h2>
                <div class="mt-2">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mt-3">
                            <div class="text-sm font-bold text-gray-700 tracking-wide">Faculty Number</div>
                            <x-jet-input type="number" name="facultyNumber" :value="old('facultyNumber')" required autofocus autocomplete="" required class=" p-2 w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Faculty No. (ex. 1910000)" />
                        </div>

                        <div class="mt-3">
                            <div class="text-sm font-bold text-gray-700 tracking-wide">Faculty Name</div>
                            <x-jet-input type="text" name="name" :value="old('name')" required autofocus autocomplete="name" class=" p-2 w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" placeholder="Your Name (Ex. Anne Reyes)" />
                        </div>

                        <div class="mt-3">
                            <div class="text-sm font-bold text-gray-700 tracking-wide">Email Address</div>
                            <x-jet-input type="email" name="email" :value="old('email')" required class=" p-2 w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Enter your email here" />
                        </div>
        ...
        <div class="hidden lg:flex items-center justify-center bg-gray-800 flex-1 h-screen">
            <div class="max-w-xs transform duration-200 hover:scale-110 cursor-pointer">
                <img src="https://cdn.discordapp.com/attachments/971130306751000636/1013875835075317790/Mapahs-modified.png" alt="">
            </div>
        </div>
    </div>
</body>
